...
El alcance de estas redes depende del estudio. En redes de interacción entre proteínas, el análisis se usa para identificar proteínas esenciales, complejos funcionales y módulos asociados a enfermedad
...
% \section*{Conclusión}
Consideradas en conjunto, las clases de redes, sus propiedades y sus formas de modelado convergen en la idea de que el análisis de redes biológicas adquiere valor cuando sus estructuras se interpretan de acuerdo con el sistema biológico representado.
