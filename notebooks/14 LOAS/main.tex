...
Una red biológica representa relaciones entre elementos de un sistema vivo: proteínas, genes, metabolitos, neuronas, especies o regiones del genoma. Su interés no está solo en enumerar componentes, sino en describir cómo se organizan sus vínculos. Por eso, el enfoque de redes ocupa un lugar central en la biología de sistemas, la bioinformática, la neurociencia y la ecología \parencite{EmmertStreib2015,Koutrouli2020,BullmoreSporns2009}.

La perspectiva topológica\footnote{En este ensayo, \enquote{topológico} no alude a la topología algebraica, sino al estudio de la forma relacional de la gráfica: quién se conecta con quién, con qué dirección, con qué intensidad y con qué organización global.} permite comparar sistemas muy distintos mediante nodos, aristas y propiedades estructurales. Sin embargo, su valor no consiste en aplicar las mismas medidas a cualquier red, sino en interpretar cada propiedad según el significado biológico del nodo y de la arista. No significa lo mismo un nodo central en una red de proteínas que en una red trófica o en una red de cromatina.
\footnote{Aquí la palabra \enquote{clase} se usa en un sentido amplio: designa familias de redes que comparten una misma lógica de representación, aunque cambien la escala, los objetos biológicos y el tipo de relación.}

Este ensayo sostiene que las redes biológicas son especialmente valiosas cuando sus propiedades, su modelado y sus aplicaciones se analizan de manera específica para cada clase de red. Por ello, no basta con preguntar qué propiedades tiene una red en abstracto; hay que preguntar qué significa cada propiedad en redes de interacción entre proteínas, en redes metabólicas, regulatorias, neuronales, ecológicas o de contacto cromatínico, y qué problemas concretos permite estudiar en cada caso.

\section*{Desarrollo}

\subsection*{1. Redes comprendidas en la clase}

La primera gran familia es la de las redes moleculares. Allí se incluyen las redes de interacción entre proteínas, donde una arista representa contacto físico o asociación funcional; las redes metabólicas, donde las conexiones expresan transformaciones bioquímicas entre metabolitos o relaciones entre metabolitos y reacciones; las redes de señalización, que describen cascadas de activación e inhibición; las redes de coexpresión génica, que conectan genes con patrones de expresión semejantes; y las redes de regulación génica, en las que las aristas representan control transcripcional o postranscripcional \parencite{Koutrouli2020,ZhangHorvath2005,EmmertStreib2014,BanfRhee2017}.
...
Lo importante es que esta clase no es homogénea. Una arista puede significar contacto físico, flujo de materia, regulación, correlación, sinapsis, interacción ecológica o proximidad espacial. Precisamente por eso, las mismas medidas topológicas cambian de sentido según la red que se esté estudiando.

\subsection*{2. Caracterización y propiedades}

Una red biológica puede escribirse como una gráfica \(G=(V,E)\) o, si importa la intensidad del vínculo, como una red ponderada con pesos \(w_{ij}\). La medida más inmediata es el grado \(k_i=\sum_j a_{ij}\), y en redes ponderadas conviene añadir la fuerza \(s_i=\sum_j w_{ij}\). Sin embargo, estas cantidades solo se vuelven informativas cuando se interpretan dentro de una clase concreta de red \parencite{Koutrouli2020}.

En las redes de interacción entre proteínas, un grado alto suele indicar que una proteína participa en muchos complejos o procesos celulares. La intermediación alta sugiere que una proteína conecta módulos funcionales distintos y puede actuar como cuello de botella entre procesos. El agrupamiento alto suele reflejar complejos proteicos o ensamblajes moleculares. Por eso, en esta clase de red, centralidad y modularidad se interpretan como pistas sobre organización funcional y esencialidad celular, aunque siempre con cautela frente a sesgos experimentales y de anotación \parencite{Jeong2001,Joy2005,Koutrouli2020}.

En las redes metabólicas, la dirección de la arista es decisiva porque una reacción no equivale a su inversa. El grado alto de un metabolito puede señalar una posición central en el intercambio bioquímico, pero también puede reflejar metabolitos moneda como ATP, agua o NADH, que conectan muchas reacciones y por eso deben tratarse con cuidado. La longitud de camino se interpreta como cercanía transformacional entre compuestos; la modularidad suele aproximar rutas metabólicas o subsistemas bioquímicos; y la existencia de caminos alternativos sugiere redundancia y plasticidad metabólica \parencite{Koutrouli2020,EmmertStreib2015}.

En las redes de señalización y regulación génica, la dirección y el signo del enlace son indispensables. El grado de salida de un factor de transcripción indica el alcance de su influencia regulatoria; el grado de entrada de un gen señala cuántas señales convergen sobre él. Los circuitos de retroalimentación positiva suelen asociarse con memoria y estabilización de estados celulares, mientras que la retroalimentación negativa se vincula con homeostasis y amortiguación. El motivo \textit{feed-forward loop} suele interpretarse como un módulo capaz de filtrar ruido o introducir respuestas selectivas en el tiempo \parencite{ManganAlon2003,ShenOrr2002,EmmertStreib2014,BanfRhee2017}. En estas redes, la topología local se interpreta casi siempre en términos dinámicos.

Las redes de coexpresión requieren una lectura distinta. Allí una arista no representa regulación directa, sino semejanza estadística entre perfiles de expresión. Por eso, un módulo de coexpresión se interpreta como un programa transcripcional compartido o como una firma asociada a un tipo celular, una condición fisiológica o una enfermedad. Un gen concentrador dentro del módulo puede ser un buen marcador o un candidato prioritario, pero no necesariamente un regulador causal. En esta clase, la modularidad suele ser más informativa que la centralidad global, y la interpretación correcta exige no confundir correlación con control \parencite{ZhangHorvath2005,Zheng2021,Gnanakkumaar2019}.

En las redes neuronales, el agrupamiento y la modularidad suelen interpretarse como segregación funcional, es decir, como especialización de subredes que procesan tareas distintas. La longitud media de camino y ciertas configuraciones de pequeño mundo se interpretan como eficiencia de integración entre regiones distantes. Los motivos recurrentes pueden señalar microcircuitos de procesamiento, y los nodos altamente conectados pueden comportarse como centros integradores cuya alteración afecta de manera desproporcionada al conjunto \parencite{BullmoreSporns2009,Mittal2024}. Aquí la propiedad topológica interesa porque se conecta con la organización del procesamiento neuronal, no solo con la forma de la gráfica.
...
El modelado depende de la clase de red. Las redes de interacción entre proteínas suelen construirse a partir de ensayos de doble híbrido, purificación por afinidad acoplada a espectrometría de masas y bases de datos curadas. En general se modelan como gráficas no dirigidas, a veces ponderados por confianza experimental \parencite{Smits2016,Koutrouli2020}. Las redes metabólicas, en cambio, suelen derivarse de reconstrucciones estequiométricas y pueden representarse como gráficas dirigidas o bipartitos metabolito--reacción. Cuando se quiere pasar de la topología al funcionamiento, se integran restricciones de flujo y análisis de balance metabólico \parencite{Koutrouli2020}.
...
Las redes ecológicas se obtienen mediante observación de campo, registros de dieta, visitas florales o seguimiento de interacción social. Según el problema, pueden modelarse como redes dirigidas, bipartitas o ponderadas. Luego se aplican simulaciones de extinción, análisis de robustez y detección de especies clave \parencite{Bascompte2009,Memmott2004,Olesen2007}. En las redes de cromatina, por último, el modelado parte de matrices de contacto generadas por técnicas como Hi-C o GAM, que luego se transforman en gráficas espaciales para detectar regiones con interacción frecuente y relaciones reguladoras de largo alcance \parencite{Beagrie2017}.
